...
import '../Kitchen/kitchen_menu/dip/view_added_food.dart';
import '../Kitchen/kitchen_menu/foodfingers/view_fdfingers.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  AdminAppterizers(),
    );
  }
}

class AdminAppterizers extends StatefulWidget {
  @override
  State<AdminAppterizers> createState() => _AdminAppterizersState();
}

class _AdminAppterizersState extends State<AdminAppterizers> {
  @override
  var appetizersType = [
  ...
  var appt =[AdminMenu(),foodfingers(),ViewFood(),ViewFood(),ViewFood(),ViewFood()];
