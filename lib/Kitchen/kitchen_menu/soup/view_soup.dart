...
class viewSoup extends StatefulWidget {
  @override
  State<viewSoup> createState() => _viewSoupState();
}

class _viewSoupState extends State<viewSoup> {

  final CollectionReference menu = FirebaseFirestore.instance.collection('soup');
