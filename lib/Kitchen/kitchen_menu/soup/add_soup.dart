...
import 'package:my_restaurant/Kitchen/kitchen_menu/soup/view_soup.dart';
...
class AddSoup extends StatefulWidget {
  AddSoup({super.key});

  @override
  State<AddSoup> createState() => _AddSoupState();
}

class _AddSoupState extends State<AddSoup> {
  final CollectionReference sp = FirebaseFirestore.instance.collection('soup');
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                soupFd();
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => AddSoup()));
                                              },
                                              child: Text(
                                                "Add Food Details",
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => viewSoup()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
