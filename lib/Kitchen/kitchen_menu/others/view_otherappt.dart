...
class ViewOthers extends StatefulWidget {
  @override
  State<ViewOthers> createState() => _ViewOthersState();
}

class _ViewOthersState extends State<ViewOthers> {
  final CollectionReference menu = FirebaseFirestore.instance.collection('others');
