...
class _AddSandwichState extends State<AddSandwich> {
  ...
  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('sandwich'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewSandwich()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('sandwich').add(fooditemm);
