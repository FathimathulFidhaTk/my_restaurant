...
class AddStuffedFood extends StatefulWidget {
  AddStuffedFood({super.key});

  @override
  State<AddStuffedFood> createState() => _AddStuffedFoodState();
}

class _AddStuffedFoodState extends State<AddStuffedFood> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('stuffedfoods'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewStuffedFoods()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('stuffedfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('stuffedfoods').add(fooditemm);
