...
class AddFoodSalads extends StatefulWidget {
  AddFoodSalads({super.key});

  @override
  State<AddFoodSalads> createState() => _AddFoodSaladsState();
}
...
class _AddFoodSaladsState extends State<AddFoodSalads> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewFoodSalads()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('foodsalads_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('salads').add(fooditemm);
