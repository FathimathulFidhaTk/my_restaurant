...
class AddFoodFingers extends StatefulWidget {
  AddFoodFingers({super.key});

  @override
  State<AddFoodFingers> createState() => _AddFoodFingersState();
}
...
class _AddFoodFingersState extends State<AddFoodFingers> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewFoodFingers()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('foodfingers_images/$fileName');
