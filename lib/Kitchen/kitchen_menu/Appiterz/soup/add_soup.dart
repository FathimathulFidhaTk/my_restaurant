...
class AddFoodSoups extends StatefulWidget {
  AddFoodSoups({super.key});

  @override
  State<AddFoodSoups> createState() => _AddFoodSoupsState();
}

class _AddFoodSoupsState extends State<AddFoodSoups> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('soup'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewFoodSoup()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('foodsoup_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('soup').add(fooditemm);
