...
import 'package:my_restaurant/Kitchen/kitchen_menu/Appiterz/dip/view_food_dip.dart';
...
class AddFoodDip extends StatefulWidget {
  AddFoodDip({super.key});

  @override
  State<AddFoodDip> createState() => _AddFoodDipState();
}

class _AddFoodDipState extends State<AddFoodDip> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('food menu');
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewFoodDip()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('food menu').add(fooditemm);
