...
class AddOtherFood extends StatefulWidget {
  AddOtherFood({super.key});

  @override
  State<AddOtherFood> createState() => _AddOtherFoodState();
}
...
class _AddOtherFoodState extends State<AddOtherFood> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewOtherFoodDetails()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('otherfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('others').add(fooditemm);
