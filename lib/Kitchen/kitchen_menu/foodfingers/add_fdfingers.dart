...
import 'package:my_restaurant/Kitchen/kitchen_menu/foodfingers/view_fdfingers.dart';
...
class AddFdfingers extends StatefulWidget {
  AddFdfingers({super.key});

  @override
  State<AddFdfingers> createState() => _AddFdfingersState();
}

class _AddFdfingersState extends State<AddFdfingers> {
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                addFood();
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => AddFdfingers()));
                                              },
                                              child: Text(
                                                "Add Food Details",
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => foodfingers()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
