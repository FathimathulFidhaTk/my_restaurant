...
class viewSalads extends StatefulWidget {
  @override
  State<viewSalads> createState() => _viewSaladsState();
}

class _viewSaladsState extends State<viewSalads> {

  final CollectionReference menu = FirebaseFirestore.instance.collection('salads');
