...
class AddSalads extends StatefulWidget {
  AddSalads({super.key});

  @override
  State<AddSalads> createState() => _AddSaladsState();
}

class _AddSaladsState extends State<AddSalads> {
  final CollectionReference sp = FirebaseFirestore.instance.collection('salads');
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                soupFd();
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => AddSalads()));
                                              },
                                              child: Text(
                                                "Add Food Details",
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => viewSalads()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
