...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: viewStufferedFoods(),
    );
  }
}
class viewStufferedFoods extends StatefulWidget {
  @override
  State<viewStufferedFoods> createState() => _viewStufferedFoodsState();
}

class _viewStufferedFoodsState extends State<viewStufferedFoods> {

  final CollectionReference menu = FirebaseFirestore.instance.collection('stuffedfoods');
