...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  AddStuffedFoood(),
    );
  }
}

class AddStuffedFoood extends StatefulWidget {
  AddStuffedFoood({super.key});

  @override
  State<AddStuffedFoood> createState() => _AddStuffedFooodState();
}

class _AddStuffedFooodState extends State<AddStuffedFoood> {
  final CollectionReference sp = FirebaseFirestore.instance.collection('stuffedfoods');
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                soupFd();
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => AddStuffedFoood()));
                                              },
                                              child: Text(
                                                "Add Food Details",
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => viewStufferedFoods()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
