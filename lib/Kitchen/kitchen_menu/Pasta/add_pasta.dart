...
class AddPasta extends StatefulWidget {
  AddPasta({super.key});

  @override
  State<AddPasta> createState() => _AddPastaState();
}

class _AddPastaState extends State<AddPasta> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('pasta'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewPasta()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('pastafood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('pasta').add(fooditemm);
