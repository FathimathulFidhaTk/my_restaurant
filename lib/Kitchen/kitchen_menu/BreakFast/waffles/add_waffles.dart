...
import 'package:my_restaurant/Kitchen/kitchen_menu/BreakFast/waffles/view_waffles.dart';
...
class AddWaffles extends StatefulWidget {
  AddWaffles({super.key});

  @override
  State<AddWaffles> createState() => _AddWafflesState();
}

class _AddWafflesState extends State<AddWaffles> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('waffle'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewWaffles()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('wafflesfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('waffle').add(fooditemm);
