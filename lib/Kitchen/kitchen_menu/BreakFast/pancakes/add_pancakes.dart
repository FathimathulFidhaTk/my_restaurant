...
import 'package:my_restaurant/Kitchen/kitchen_menu/BreakFast/pancakes/view_pancakes.dart';
...
class AddPancakes extends StatefulWidget {
  AddPancakes({super.key});

  @override
  State<AddPancakes> createState() => _AddPancakesState();
}

class _AddPancakesState extends State<AddPancakes> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('pancakes'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewPacakes()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('pancakefood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('pancakes').add(fooditemm);
