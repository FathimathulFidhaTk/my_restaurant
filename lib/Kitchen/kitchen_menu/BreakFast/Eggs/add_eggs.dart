...
class AddEggs extends StatefulWidget {
  AddEggs({super.key});

  @override
  State<AddEggs> createState() => _AddEggsState();
}

class _AddEggsState extends State<AddEggs> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('eggs'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewEggs()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('Eggfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('eggs').add(fooditemm);
