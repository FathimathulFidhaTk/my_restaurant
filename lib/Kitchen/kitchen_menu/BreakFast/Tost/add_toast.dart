...
class AddToast extends StatefulWidget {
  ...
  @override
  State<AddToast> createState() => _AddToastState();
}
...
class _AddToastState extends State<AddToast> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewToast()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('toastfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('ttoast').add(fooditemm);
