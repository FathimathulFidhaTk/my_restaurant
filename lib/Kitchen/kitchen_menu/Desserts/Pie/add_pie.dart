...
class AddPie extends StatefulWidget {
  AddPie({super.key});

  @override
  State<AddPie> createState() => _AddPieState();
}

class _AddPieState extends State<AddPie> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('pie'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewPie()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('piefood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('pie').add(fooditemm);
