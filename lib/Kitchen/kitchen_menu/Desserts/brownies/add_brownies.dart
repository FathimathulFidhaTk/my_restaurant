...
class AddBrownies extends StatefulWidget {
  AddBrownies({super.key});

  @override
  State<AddBrownies> createState() => _AddBrowniesState();
}

class _AddBrowniesState extends State<AddBrownies> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('brownies'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewBrownies()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('brownifood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('brownies').add(fooditemm);
