...
class _AddCakeState extends State<AddCake> {
  ...
  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('cake'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewCakes()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('cakefood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('cake').add(fooditemm);
