...
class _AddIcecreamState extends State<AddIcecream> {
  ...
  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('icecream'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewIcecream()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('icecreamfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('icecream').add(fooditemm);
