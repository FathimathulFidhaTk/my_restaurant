...
class AddPuddings extends StatefulWidget {
  AddPuddings({super.key});

  @override
  State<AddPuddings> createState() => _AddPuddingsState();
}
...
class _AddPuddingsState extends State<AddPuddings> {
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('puddingfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('pudding').add(fooditemm);
