...
class AddChocolate extends StatefulWidget {
  AddChocolate({super.key});

  @override
  State<AddChocolate> createState() => _AddChocolateState();
}

class _AddChocolateState extends State<AddChocolate> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('chocolate'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewChocolate()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('chocolatefood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('chocolate').add(fooditemm);
