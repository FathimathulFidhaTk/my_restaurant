...
class AddCookies extends StatefulWidget {
  AddCookies({super.key});

  @override
  State<AddCookies> createState() => _AddCookiesState();
}

class _AddCookiesState extends State<AddCookies> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('cookies'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewCookies()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('cookiesfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('cookies').add(fooditemm);
