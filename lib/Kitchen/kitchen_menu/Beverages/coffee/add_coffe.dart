...
import 'package:my_restaurant/Kitchen/kitchen_menu/Beverages/coffee/view_coffe.dart';
...
class _AddCoffeeState extends State<AddCoffee> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewCoffee()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('Coffee_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('coffee').add(fooditemm);
