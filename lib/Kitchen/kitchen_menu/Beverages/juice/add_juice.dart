...
import 'package:my_restaurant/Kitchen/kitchen_menu/Beverages/juice/view_juice.dart';
...
class _AddJuiceState extends State<AddJuice> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewJuices()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('Juice_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('juices').add(fooditemm);
