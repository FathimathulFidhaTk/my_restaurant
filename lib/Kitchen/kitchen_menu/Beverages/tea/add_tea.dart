...
import 'package:my_restaurant/Kitchen/kitchen_menu/Beverages/tea/view_tea.dart';

class AddTea extends StatefulWidget {
  AddTea({super.key});

  @override
  State<AddTea> createState() => _AddTeaState();
}

class _AddTeaState extends State<AddTea> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewTea()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('tea_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('tea').add(fooditemm);
