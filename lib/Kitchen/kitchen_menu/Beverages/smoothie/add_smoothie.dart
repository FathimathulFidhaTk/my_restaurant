...
class AddSmoothie extends StatefulWidget {
  ...
  @override
  State<AddSmoothie> createState() => _AddSmoothieState();
}

class _AddSmoothieState extends State<AddSmoothie> {
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('smoothie_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('smoothie').add(fooditemm);
