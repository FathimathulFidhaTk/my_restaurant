...
import 'package:my_restaurant/Kitchen/kitchen_menu/Beverages/milkshakes/view_milkshakes.dart';

class AddMilkshakes extends StatefulWidget {
  AddMilkshakes({super.key});

  @override
  State<AddMilkshakes> createState() => _AddMilkshakesState();
}

class _AddMilkshakesState extends State<AddMilkshakes> {
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewMilkshake()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('Milkshake_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('milkshakes').add(fooditemm);
