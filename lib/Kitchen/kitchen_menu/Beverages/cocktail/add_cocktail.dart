...
import 'package:my_restaurant/Kitchen/kitchen_menu/Beverages/cocktail/view_cocktail.dart';

class AddCocktail extends StatefulWidget {
  AddCocktail({super.key});
...
class _AddCocktailState extends State<AddCocktail> {
  ...
  final CollectionReference _foodCollection = FirebaseFirestore.instance
      .collection('cocktails'); // Replace with your collection name
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      String fileName = file.path
          .split('/')
          .last;
      Reference ref = storage.ref().child('Cocktailfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('cocktails').add(fooditemm);
