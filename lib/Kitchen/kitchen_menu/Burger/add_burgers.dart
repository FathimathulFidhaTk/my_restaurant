...
import 'package:my_restaurant/Kitchen/kitchen_menu/Burger/view_burgers.dart';
import 'package:my_restaurant/Kitchen/kitchen_menu/Pasta/view_pasta.dart';
import 'package:my_restaurant/Kitchen/kitchen_menu/Piza/view_pizza.dart';
import 'package:my_restaurant/Kitchen/kitchen_menu/Sandwich/view_sandwich.dart';
...
class AddBurgers extends StatefulWidget {
  AddBurgers({super.key});

  @override
  State<AddBurgers> createState() => _AddBurgersState();
}

class _AddBurgersState extends State<AddBurgers> {

  final CollectionReference _foodCollection = FirebaseFirestore.instance.collection('burgers'); // Replace with your collection name
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(context, MaterialPageRoute(builder: (context) => ViewBurgers()));
                                              },
                                              child: Text(
                                                "View Food Details",
                                                style: GoogleFonts.alegreya(
  ...
  Future<void> _uploadImage() async {
    ...
    if (pickedFile != null) {
      ...
      Reference ref = storage.ref().child('sandwichfood_images/$fileName');
      ...
      task.whenComplete(() async {
        ...
        await firestore.collection('burgers').add(fooditemm);
