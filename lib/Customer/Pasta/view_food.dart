...
import 'package:my_restaurant/Customer/Pasta/view_more.dart';
...
class ViewCustPasta extends StatefulWidget {
  @override
  State<ViewCustPasta> createState() => _ViewCustPastaState();
}

class _ViewCustPastaState extends State<ViewCustPasta> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('pasta').snapshots(),
