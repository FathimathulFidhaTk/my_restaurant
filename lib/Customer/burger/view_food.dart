...
class ViewCustBurger extends StatefulWidget {
  @override
  State<ViewCustBurger> createState() => _ViewCustBurgerState();
}

class _ViewCustBurgerState extends State<ViewCustBurger> {
