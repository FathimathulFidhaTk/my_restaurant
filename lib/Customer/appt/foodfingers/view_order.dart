...
class FdFingersOrderPage extends StatefulWidget {
  ...
  FdFingersOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<FdFingersOrderPage> createState() => _FdFingersOrderPageState();
}

class _FdFingersOrderPageState extends State<FdFingersOrderPage> {
