...
class FoodFingersPage extends StatefulWidget {
  ...
  FoodFingersPage(this.foodName, this.foodDescription, this.foodDocumentId, this.imageUrl,this.foodPrice);

  @override
  State<FoodFingersPage> createState() => _FoodFingersPageState();
}

class _FoodFingersPageState extends State<FoodFingersPage> {
