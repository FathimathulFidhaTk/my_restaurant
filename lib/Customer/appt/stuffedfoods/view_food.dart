...
import 'package:my_restaurant/Customer/appt/stuffedfoods/view_more.dart';
...
class ViewStuffedFood extends StatefulWidget {
  @override
  State<ViewStuffedFood> createState() => _ViewStuffedFoodState();
}

class _ViewStuffedFoodState extends State<ViewStuffedFood> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('stuffedfoods').snapshots(),
                  ...
                  return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => StuffedFoodPage(
