...
import 'package:my_restaurant/Customer/appt/stuffedfoods/view_order.dart';
import 'package:path/path.dart' as path;

import 'package:firebase_storage/firebase_storage.dart';
import 'package:flutter/material.dart';

class StuffedFoodPage extends StatefulWidget {
  ...
  StuffedFoodPage(this.foodName, this.foodDescription, this.foodDocumentId, this.imageUrl,this.foodPrice);

  @override
  State<StuffedFoodPage> createState() => _StuffedFoodPageState();
}

class _StuffedFoodPageState extends State<StuffedFoodPage> {
