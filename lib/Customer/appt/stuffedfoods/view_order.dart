...
class StuffedFoodOrderPage extends StatefulWidget {
  ...
  StuffedFoodOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<StuffedFoodOrderPage> createState() => _StuffedFoodOrderPageState();
}

class _StuffedFoodOrderPageState extends State<StuffedFoodOrderPage> {
