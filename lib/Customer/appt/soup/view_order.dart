...
class SoupOrderPage extends StatefulWidget {
  ...
  SoupOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<SoupOrderPage> createState() => _SoupOrderPageState();
}

class _SoupOrderPageState extends State<SoupOrderPage> {
