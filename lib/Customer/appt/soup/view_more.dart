...
import 'package:my_restaurant/Customer/appt/soup/view_order.dart';
...
class SoupPage extends StatefulWidget {
  ...
  SoupPage(this.foodName, this.foodDescription, this.foodDocumentId, this.imageUrl,this.foodPrice);
