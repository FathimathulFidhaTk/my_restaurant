...
import 'package:my_restaurant/Customer/breakfastt/waffles/view_more.dart';
...
class ViewCustWaffle extends StatefulWidget {
  @override
  State<ViewCustWaffle> createState() => _ViewCustWaffleState();
}

class _ViewCustWaffleState extends State<ViewCustWaffle> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('waffle').snapshots(),
