...
class WaffleOrderPage extends StatefulWidget {
  ...
  WaffleOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<WaffleOrderPage> createState() => _WaffleOrderPageState();
}

class _WaffleOrderPageState extends State<WaffleOrderPage> {
