...
class EggOrderPage extends StatefulWidget {
  ...
  EggOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<EggOrderPage> createState() => _EggOrderPageState();
}

class _EggOrderPageState extends State<EggOrderPage> {
