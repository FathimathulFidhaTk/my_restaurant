...
import 'package:my_restaurant/Customer/breakfastt/pancakes/view_more.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ViewCustPancakes(),
    );
  }
}

class ViewCustPancakes extends StatefulWidget {
  @override
  State<ViewCustPancakes> createState() => _ViewCustPancakesState();
}

class _ViewCustPancakesState extends State<ViewCustPancakes> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('pancakes').snapshots(),
