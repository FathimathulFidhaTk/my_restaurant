...
class PancakeOrderPage extends StatefulWidget {
  ...
  PancakeOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<PancakeOrderPage> createState() => _PancakeOrderPageState();
}

class _PancakeOrderPageState extends State<PancakeOrderPage> {
