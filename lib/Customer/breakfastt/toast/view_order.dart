...
class ToastOrderPage extends StatefulWidget {
  ...
  ToastOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<ToastOrderPage> createState() => _ToastOrderPageState();
}

class _ToastOrderPageState extends State<ToastOrderPage> {
