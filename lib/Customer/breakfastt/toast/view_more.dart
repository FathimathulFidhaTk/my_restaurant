...
import 'package:my_restaurant/Customer/breakfastt/toast/view_order.dart';
...
class ToastPage extends StatefulWidget {
  ...
  ToastPage(this.foodName, this.foodDescription, this.foodDocumentId, this.imageUrl,this.foodPrice);
