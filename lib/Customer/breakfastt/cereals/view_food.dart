...
class ViewCustCerals extends StatefulWidget {
  @override
  State<ViewCustCerals> createState() => _ViewCustCeralsState();
}

class _ViewCustCeralsState extends State<ViewCustCerals> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('cerals').snapshots(),
