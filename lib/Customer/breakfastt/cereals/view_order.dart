...
class CeralsOrderPage extends StatefulWidget {
  ...
  CeralsOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<CeralsOrderPage> createState() => _CeralsOrderPageState();
}

class _CeralsOrderPageState extends State<CeralsOrderPage> {
