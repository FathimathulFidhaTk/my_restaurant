...
class CeralPage extends StatefulWidget {
  ...
  CeralPage(this.foodName, this.foodDescription, this.foodDocumentId, this.imageUrl,this.foodPrice);

  @override
  State<CeralPage> createState() => _CeralPageState();
}

class _CeralPageState extends State<CeralPage> {
