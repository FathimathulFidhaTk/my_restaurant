...
import 'package:my_restaurant/Customer/desert/icecream/view_order.dart';
...
class IcecreamPage extends StatefulWidget {
  ...
  IcecreamPage(this.foodName, this.foodDescription, this.foodDocumentId, this.imageUrl);
