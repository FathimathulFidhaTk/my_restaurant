...
import 'package:my_restaurant/Customer/desert/icecream/view_more.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ViewCustIcecream(),
    );
  }
}


class ViewCustIcecream extends StatefulWidget {
  @override
  State<ViewCustIcecream> createState() => _ViewCustIcecreamState();
}

class _ViewCustIcecreamState extends State<ViewCustIcecream> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('icecream').snapshots(),
