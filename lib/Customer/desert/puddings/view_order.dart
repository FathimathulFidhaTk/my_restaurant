...
class PuddingOrderPage extends StatefulWidget {
  ...
  PuddingOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<PuddingOrderPage> createState() => _PuddingOrderPageState();
}

class _PuddingOrderPageState extends State<PuddingOrderPage> {
