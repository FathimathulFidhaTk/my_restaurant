...
import 'package:my_restaurant/Customer/burger/view_more.dart';
import 'package:my_restaurant/Customer/desert/puddings/view_more.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ViewCustPudding(),
    );
  }
}


class ViewCustPudding extends StatefulWidget {
  @override
  State<ViewCustPudding> createState() => _ViewCustPuddingState();
}

class _ViewCustPuddingState extends State<ViewCustPudding> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('pudding').snapshots(),
