...
import 'package:my_restaurant/Customer/desert/chocolates/view_more.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ViewCustChocolate(),
    );
  }
}


class ViewCustChocolate extends StatefulWidget {
  @override
  State<ViewCustChocolate> createState() => _ViewCustChocolateState();
}

class _ViewCustChocolateState extends State<ViewCustChocolate> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('chocolate').snapshots(),
