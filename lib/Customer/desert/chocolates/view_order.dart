...
class ChocolateOrderPage extends StatefulWidget {
  ...
  ChocolateOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<ChocolateOrderPage> createState() => _ChocolateOrderPageState();
}

class _ChocolateOrderPageState extends State<ChocolateOrderPage> {
