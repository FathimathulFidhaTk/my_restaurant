...
import 'package:my_restaurant/Customer/desert/chocolates/view_order.dart';
...
class ChocolatePage extends StatefulWidget {
  ...
  ChocolatePage(this.foodName, this.foodDescription, this.foodDocumentId, this.imageUrl);
