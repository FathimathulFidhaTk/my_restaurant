...
class BrowniOrderPage extends StatefulWidget {
  ...
  BrowniOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<BrowniOrderPage> createState() => _BrowniOrderPageState();
}

class _BrowniOrderPageState extends State<BrowniOrderPage> {
