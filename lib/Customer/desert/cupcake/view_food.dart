...
import 'package:my_restaurant/Customer/desert/cupcake/view_more.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home:  ViewCustCupcake(),
    );
  }
}


class ViewCustCupcake extends StatefulWidget {
  @override
  State<ViewCustCupcake> createState() => _ViewCustCupcakeState();
}

class _ViewCustCupcakeState extends State<ViewCustCupcake> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('cupcake').snapshots(),
