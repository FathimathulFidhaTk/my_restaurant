...
class CupcakeOrderPage extends StatefulWidget {
  ...
  CupcakeOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<CupcakeOrderPage> createState() => _CupcakeOrderPageState();
}

class _CupcakeOrderPageState extends State<CupcakeOrderPage> {
