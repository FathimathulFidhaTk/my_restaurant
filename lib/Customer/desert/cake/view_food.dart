...
import 'package:my_restaurant/Customer/desert/cake/view_more.dart';
...
class ViewCustCake extends StatefulWidget {
  @override
  State<ViewCustCake> createState() => _ViewCustCakeState();
}

class _ViewCustCakeState extends State<ViewCustCake> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('cake').snapshots(),
