...
import 'package:my_restaurant/Customer/desert/pie/view_more.dart';
...
class ViewCustPie extends StatefulWidget {
  @override
  State<ViewCustPie> createState() => _ViewCustPieState();
}

class _ViewCustPieState extends State<ViewCustPie> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('pie').snapshots(),
