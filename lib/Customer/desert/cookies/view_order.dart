...
class CookiesOrderPage extends StatefulWidget {
  ...
  CookiesOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<CookiesOrderPage> createState() => _CookiesOrderPageState();
}

class _CookiesOrderPageState extends State<CookiesOrderPage> {
