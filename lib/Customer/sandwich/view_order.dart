...
class SandwichOrderPage extends StatefulWidget {
  ...
  SandwichOrderPage(this.foodName, this.foodDescription, this.foodQuantity,this.imageUrl);

  @override
  State<SandwichOrderPage> createState() => _SandwichOrderPageState();
}

class _SandwichOrderPageState extends State<SandwichOrderPage> {
