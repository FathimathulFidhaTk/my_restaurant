...
import 'package:my_restaurant/Customer/sandwich/view_more.dart';


class ViewCustSandwich extends StatefulWidget {
  @override
  State<ViewCustSandwich> createState() => _ViewCustSandwichState();
}

class _ViewCustSandwichState extends State<ViewCustSandwich> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('sandwich').snapshots(),
